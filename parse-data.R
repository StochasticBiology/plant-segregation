### parse data in Excel sheets into conveniently-structured CSV filed for plotting and inference

library(readxl)
library(stringr)

# during project development we wondered whether to do inference while excluding "old leaf" data. in the current incarnation there is no reason to do so; this is a legacy option
exclude.ol = F
...
# within-child data
tissue.tib = read_excel("Data/ALL_within plant_2022-10-14.xlsx")
...
for(organelle in organelles) {
  for(background in backgrounds) {
    ...
    # convert "old leaf" and "young leaf" into "early leaf" and "late leaf" according to sampling time
    ...
    # process these observed families separately
    ...
    # separate out published and new observations
