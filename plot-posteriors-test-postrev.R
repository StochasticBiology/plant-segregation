...
for(i in 1:length(expts)) {
  ...
  subplots1[[i]][[2]] = ggplot(df, aes(x=eff1, fill=factor(seed))) + geom_histogram(aes(y=..density..), position="dodge",bins=nbins) + xlab("nₑ₁") + xlim(xmin,xmax) +theme_classic() + theme(legend.position="none") 
  subplots1[[i]][[3]] = ggplot(df, aes(x=eff2, fill=factor(seed))) + geom_histogram(aes(y=..density..), position="dodge",bins=nbins)+ xlab("nₑ₂") + xlim(xmin,xmax) +theme_classic() + theme(legend.position="none") 
  subplots1[[i]][[4]] = ggplot(df, aes(x=eff3, fill=factor(seed))) + geom_histogram(aes(y=..density..), position="dodge",bins=nbins)+ xlab("nₑ₃") + xlim(xmin,xmax) +theme_classic() + theme(legend.position="none") 
  subplots1[[i]][[5]] = ggplot(df, aes(x=eff4, fill=factor(seed))) + geom_histogram(aes(y=..density..), position="dodge",bins=nbins) + xlab("nₑ₄")+ xlim(xmin,xmax) +theme_classic() + theme(legend.position="none") 
  # model index
  ...
  subplots1[[i]][[7]] = ggplot(df, aes(x=index/1000, y=lik)) + geom_line()  + theme_classic()
