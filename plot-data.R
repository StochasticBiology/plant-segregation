...
png("fig-1-old-data-plots-var-newest.png", width=820*gsf, height=600*gsf, res=72*ressf)
...
png("fig-3ab-new-data-plots-var-newest.png", width=820*gsf, height=400*gsf, res=72*ressf)
